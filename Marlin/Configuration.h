...
#define STRING_CONFIG_H_AUTHOR "Geoff" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Feb 2"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 467.2 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -10, -2.58 }
